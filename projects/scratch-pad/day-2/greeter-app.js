...
function greeter(hour) {
    ...
    if(0 <= hour && hour <= 11){    //checking input value is between 0 and 11
         console.log('Good Morning!');
    } else if (12 <= hour && hour <= 16){   //checking input value is between 12 and 16
        console.log('Good Afternoon!');
    } else if(17 <= hour && hour <= 21){    //checking input value is between 17 and 21
         console.log('Good Evening!');          
    } else if(22 <= hour && hour <= 24){    //checking input value is between 22 and 24
         console.log('Good Night!');
    } //else return console.log('Not a valid time.')
